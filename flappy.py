...
icon = pygame.image.load("assets/flappy-bird-icon.png")
...
# Load background
all_bg = ["background-day", "background-night"]
bg = random.choice(all_bg)
bg_surface = pygame.image.load(f"assets/{bg}.png").convert()
...
bird_downflap = pygame.transform.scale2x(
    pygame.image.load(f"assets/{bird_color}bird-downflap.png").convert_alpha()
)
bird_midflap = pygame.transform.scale2x(
    pygame.image.load(f"assets/{bird_color}bird-midflap.png").convert_alpha()
)
bird_upflap = pygame.transform.scale2x(
    pygame.image.load(f"assets/{bird_color}bird-upflap.png").convert_alpha()
)
...
pipe_surface = pygame.image.load(f"assets/pipe-{pipe_color}.png").convert()
